...
internal class RentExpiringConsumer
{
    ...
    public RentExpiringConsumer(IServiceScopeFactory serviceScopeFactory, IOptions<RabbitMQSettiings> settings)
    {
        _settings = settings;
    ...
    public async Task ConsumeAsync()
    {
        ...
        consumer.Received += async (model, ea) =>
        {
            ...
            try
            {
                var rentGeneratedEvent = JsonConvert.DeserializeObject<List<RentExpiringDomainEvent>>(message);
